          ...
          <div :class="advanced ? null: 'fold'">
            ...
            <a-col :md="6" :sm="24">
              <a-form-item
                ...
                :labelCol="{span: 5}"
                :wrapperCol="{span: 18, offset: 1}">
                <a-input-number style="width: 100%" :min="0" v-model="queryParams.year"/>
              </a-form-item>
            </a-col>
            <a-col :md="6" :sm="24">
              <a-form-item
                ...
                :labelCol="{span: 5}"
                :wrapperCol="{span: 18, offset: 1}">
                <a-select v-model="queryParams.quarterly" allowClear>
...
export default {
  ...
  computed: {
    ...
    columns () {
      return [{
        ...
        customRender: (text, row, index) => {
          if (text !== null) {
            return row.year + '年 ' + row.quarterly + '季度'
          } else {
            return '- -'
          }
        }
  ...
  methods: {
    ...
    fetch (params = {}) {
      ...
      if (params.quarterly === undefined) {
        delete params.quarterly
      }
